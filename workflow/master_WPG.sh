    ...
    cd $WORKDIR/packages/WPG/s2e/prop
    python $WORKDIR/packages/WPG/s2e/prop/propagateSE.py --input-directory $ROOT/data/$PROJECT/FELsource --output-directory $ROOT/data/$PROJECT/prop --cpu-number 1
